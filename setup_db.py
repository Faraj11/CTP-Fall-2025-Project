#!/usr/bin/env python3
"""
Create a SQLite database containing only New York restaurants and their reviews
...
business_dataset_relative="./yelp_dataset_extracted/yelp_academic_dataset_business.json"
review_dataset_relative="./yelp_dataset_extracted/yelp_academic_dataset_review.json"
business_absolute="/Users/ethan/Downloads/Yelp-JSON/Yelp JSON/yelp_academic_dataset_business.json"
review_absolute="/Users/ethan/Downloads/Yelp-JSON/Yelp JSON/yelp_academic_dataset_review.json"
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build CA restaurant SQLite DB from Yelp JSON files.")
    parser.add_argument(
        "--business-json",
        type=Path,
        default=Path(business_absolute),
        help="Path to the Yelp business JSON lines file.",
    )
    parser.add_argument(
        "--review-json",
        type=Path,
        default=Path(review_absolute),
